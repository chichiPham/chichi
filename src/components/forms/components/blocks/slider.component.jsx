...
import image1 from '../../assets/images/background/dich-vu-chuyen-nha-tron-goi-tphcm-750x375.jpg';
                        ...
                        <Container className="py-5">
                            <Grid container spacing={4}>
                                <Grid item xs={12} lg={7}>
                                    ...
                                    <div style={{ width: '100%' }} className="text-white mt-3">
                                        ...
                                        <img style={{ width: '100%' }} src={image1} alt="anh chuyen nha" />
